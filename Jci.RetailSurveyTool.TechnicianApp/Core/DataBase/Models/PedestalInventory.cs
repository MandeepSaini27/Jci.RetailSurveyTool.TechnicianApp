...
namespace JCI.RetailSurveyTool.DataBase.Models
{
    public class PedestalInventory : Inventory, INotifyPropertyChanged
    {
        ...
        private CustomCommand _IncrementPedQty;
        private CustomCommand _DecrementPedQty;
        private CustomCommand _IncrementSysQty;
        private CustomCommand _DecrementSysQty;
        ...
        public ICommand IncrementPedQty
        {
            get
            {
                ...
                {
                    _IncrementPedQty = new CustomCommand(() => PedestalQty++, () => PedestalQty < MAX_QTY, PropertyChanged);
        ...
        public ICommand DecrementPedQty
        {
            get
            {
                ...
                {
                    _DecrementPedQty = new CustomCommand(() => PedestalQty--, () => PedestalQty > MIN_QTY, PropertyChanged);
        ...
        public ICommand IncrementSysQty
        {
            get
            {
                ...
                {
                    _IncrementSysQty = new CustomCommand(() => SystemQty++, () => SystemQty < MAX_QTY, PropertyChanged);
        ...
        public ICommand DecrementSysQty
        {
            get
            {
                ...
                {
                    _DecrementSysQty = new CustomCommand(() => SystemQty--, () => SystemQty > MIN_QTY, PropertyChanged);
